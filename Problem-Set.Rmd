...
#Total variance
total_var = treatedprob*(1-treatedprob)*sum(table$N)
...
where $t_{\alpha/2} = 1.96$, $t_{\beta} = 0.84$, $N = 10000$, $Var(T_i) = n*p*(1-p) = 10000*0.5*0.5$, $\sigma^2 = ?$
...
where $t_{\alpha/2} = 1.96$, $t_{\beta} = 0.84$, $N = 10000$, $Var(T_i) = n*p*(1-p) = 10000*0.5*0.5$, $n = \dfrac{10000}{118}$, $\rho = 0.2$ and $\sigma^2 = ?$.
